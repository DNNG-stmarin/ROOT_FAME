...
void fragFiss::PostCalibPHD(int iterationPost)
{
  ...
  TF1* gaussFit = new TF1("gaussFit", "[0] * e^(-((x - [1])^2)/(2*[2]^2))", 0, MAX_KE);
  // yield 1
  ...
  TF1* f_gaussYield1 = new TF1("f_gaussYield1", "gaussFit + gaussFit + gaussFit", 0, MAX_KE);
  TF1* f_gaussYield2 = new TF1("f_gaussYield2", "gaussFit + gaussFit + gaussFit", 0, MAX_KE);
